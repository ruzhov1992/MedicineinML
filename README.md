Эта работа была выполнена в рамках зачётного задания для модуля «Применение машинного обучения для анализа медицинских данных» на платформе SkillFactory.
